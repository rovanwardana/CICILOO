...
<div class="flex justify-between items-center mb-4">
    ...
    <button id="addFriendButton" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<div id="addFriendSearch" class="hidden mb-4">
    <input type="text" id="friendSearch" class="w-full p-2 border rounded mb-2" placeholder="Search by name or email...">
    ...
    <div class="space-y-2">
        @forelse ($suggestedFriends as $suggestedFriend)
            <div class="flex items-center justify-between p-4 border-b border-gray-100 hover:bg-gray-50 rounded-lg">
                ...
                <button data-friend-id="{{ $suggestedFriend->id }}" class="add-friend-btn inline-flex items-center px-3 py-1 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Add Friend
                </button>
            </div>
        @empty
